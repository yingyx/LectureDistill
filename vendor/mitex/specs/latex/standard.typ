...
#let (
  ...
  vartriangleright: define-sym("gt.closed"),
  trianglerighteq: define-sym("gt.closed.eq"),
  ntrianglerighteq: define-sym("gt.closed.eq.not"),
  ntriangleright: define-sym("gt.closed.not"),
  ...
  vartriangleleft: define-sym("lt.closed"),
  trianglelefteq: define-sym("lt.closed.eq"),
  ntrianglelefteq: define-sym("lt.closed.eq.not"),
  ntriangleleft: define-sym("lt.closed.not"),
  ...
  ulcorner: define-sym("⌜"),
  unlhd: define-sym("lt.closed.eq"),
  unrhd: define-sym("gt.closed.eq"),
  urcorner: define-sym("⌝"),
  ...
  // TODO(testset): model TeX register-style commands from matrix preambles.
  "c@MaxMatrixCols": ignore-sym,
  // \edef\arraystretch{#1}%
  "let": ignore-sym,
  edef: ignore-sym,
  // todo: \newcommand{\newtheorem}[2]{\newenvironment{#1}{}{}}
